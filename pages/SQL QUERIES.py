...
""",
    ...
    "What is the total listed food quantity and unclaimed food quantity (food not claimed at all)?": """
SELECT
...
SELECT
    (EXTRACT(DOW FROM expiry_date)::int + 1) AS weekday,  -- 1=Sunday, 7=Saturday
